...
class TicTacToe
    ...
    def initialize
        ...
        @board = Board.new
        # set up players
        @player_x = Player.new("Lady X", :x, @board)
        @player_y = Player.new("Gentleman Y", :y, @board)
    ...
    def play
        ...
        loop do
            ...
            @board.render
            #a ask for coordinates from the current player
